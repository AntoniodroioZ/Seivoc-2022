    ...
    <div class="row ">
        <div class="col col-sm  col-md-2 offset-md-1 " >
            ...
            <div class="divi1" ondrop="drop(event)" ondragover="allowDrop(event)" style="border: none;">
                ...
                <a style="text-align: center;" role="button" class="comprobables bbtn btn-block nav-link btn-info"
...
<div class="container">
    ...
    <div class="col col-sm-4  col-md-4 offset-md-1">
        <a  role="button" class="flechas"  data-toggle="tooltip" data-html="true"  title="<strong>Ménu</strong>"
    ...
    <div class="col col-sm-4  col-md-4" >
        <a id ="comprueba" role="button" class="vamos bbtn btn-block nav-link btn-info" href="#firstImage" data-toggle="modal" data-target="#exampleModalLong1" onclick="correrValidaciones()">Comprobar</a>
    </div>  
    <div class= >
        <a id ="comprueba" role="button" class="vamos bbtn btn-block nav-link btn-info" href="#firstImage" data-toggle="modal" data-target="#exampleModalLong1" onclick="enviar()">Enviar respuestas</a>
    </div> 
    <div class="col col-sm-4  col-md-4">
